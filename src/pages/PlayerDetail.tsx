  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6 md:space-y-8 max-w-4xl mx-auto">
      ...
      <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 1 }} aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-muted-foreground">
        ...
        <Link to="/players" className="hover:text-primary transition-colors">Spelare</Link>
        <ChevronRight className="w-3 h-3" />
      ...
      <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, ease: [0.25, 0.46, 0.45, 0.94] }}>
        <Link to="/players" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors">
      ...
      {player && (
        ...
        >
          <div className="flex items-start justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl icon-premium flex items-center justify-center ring-2 ring-primary/20">
